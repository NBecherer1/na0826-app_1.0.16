...
class DownloadsHelper {
  ...
  Future<void> addDownloads({
    ...
    try {
      ...
      for (final item in items) {
        ...
        await _addItemToDownloadedAlbum(parent.id, item);
  ...
  /// is overwritten.
  Future<void> addDownloadedSong(DownloadedSong newDownloadedSong) async {
    await _downloadedItemsBox.put(newDownloadedSong.song.id, newDownloadedSong);
  }
  ...
  Future<void> _addItemToDownloadedAlbum(String albumId, BaseItemDto item) async {
    try {
