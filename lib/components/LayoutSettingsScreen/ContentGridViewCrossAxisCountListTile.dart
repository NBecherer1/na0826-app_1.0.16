...
class ContentGridViewCrossAxisCountListTile extends StatefulWidget {
  ...
  @override
  _ContentGridViewCrossAxisCountListTileState createState() =>
        ...
        child: TextField(
          ...
          onChanged: (value) {
            ...
            if (valueInt != null && valueInt > 0) {
              switch (widget.type) {
                case ContentGridViewCrossAxisCountType.portrait:
                  FinampSettingsHelper.setContentGridViewCrossAxisCountPortrait(valueInt);
                  break;
                case ContentGridViewCrossAxisCountType.landscape:
                  FinampSettingsHelper.setContentGridViewCrossAxisCountLandscape(valueInt);
                  break;
              }
            }
          },
